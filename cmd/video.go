...
var videoCmd = &cobra.Command{
	Use:   "video <url>",
	Short: "Add a new video to your library",
	Long:  `Add the metadata of a video to your library for post-processing to asynchronously fill in the rest.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.CreateSource(client.NewSourceLocation(title), title, source.Video, url); err != nil {
